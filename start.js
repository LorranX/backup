...
require("./index.js");
nocache("./index.js", (module) => console.log(`O modulo ${module} acaba de ser atualizado`));

async function starts(client = new WAConnection()){
  client.logger.level = 'warn';
  client.version = [3, 32349, 8];
  client.browserDescription = [ 'LORRAN-BOT', 'Baileys', '3.5.3' ];
  console.log(banner.string);
  console.log(abaixodobanner.string);
  console.log(bottombanner.string);
  client.on('qr', qr => {
     console.log(
       color("[","white"),
       color("∆","red"),
